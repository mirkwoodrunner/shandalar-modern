...
**Learn Mode pinned baseline (as of 2026-09-18, Tier 1 content complete).** When a prompt says "same as main," it means
these numbers:
...
| `npx playwright test tests/e2e/learn-slice.spec.ts` | 18 passing (9 cases x chromium + mobile-chrome) |
