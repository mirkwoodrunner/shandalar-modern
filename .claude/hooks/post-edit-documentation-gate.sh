...
echo ""
echo "  - If you added anything to CLAUDE.md, confirm it is an agent operating rule,"
echo "    not a feature spec, implementation note, or completed-work entry."
echo "    Feature specs -> docs/SYSTEMS.md"
echo "    Closed decisions -> docs/DECISIONS.md"
echo "    Completed work -> docs/CURRENT_SPRINT.md or docs/MECHANICS_INDEX.md"
echo ""
