...
// DESKTOP (1280x800)
// ---------------------------------------------------------------------------
test.describe('@engine-card-scenarios-1 @mobile Force of Nature upkeep modal [desktop]', () => {
...
// MOBILE (390x844)
// ---------------------------------------------------------------------------
test.describe('@engine-card-scenarios-1 @mobile Force of Nature upkeep modal [mobile]', () => {
