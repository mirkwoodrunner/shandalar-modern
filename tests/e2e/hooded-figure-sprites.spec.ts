...
// DESKTOP (1280x800)
// ---------------------------------------------------------------------------
test.describe('@overworld-visual-1 @mobile desktop hooded-figure sprite variant', () => {
...
// ---------------------------------------------------------------------------
test.describe('@overworld-visual-1 @mobile mobile hooded-figure sprite variant', () => {
