...
export const KEYWORDS = {
  ...
  REGENERATION:  {
    id:"REGENERATION",  name:"Regeneration",  classic:true,  modern:false,
    activatedAbility: true,
    desc:"Activated ability: instead of being destroyed, remove all damage, tap, and remove from combat.",
  },
  LANDWALK:      {
    id:"LANDWALK",      name:"Landwalk",      classic:true,  modern:false,
