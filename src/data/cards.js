...
{id:"nettling_imp",     name:"Nettling Imp",     type:"Creature",subtype:"Imp",             color:"B",cmc:3,cost:"2B",  power:1,toughness:1,keywords:["FLYING"],rarity:"C",text:"T: Target non-Wall creature must attack this turn if able or be destroyed at end of combat.",activated:{cost:"T",effect:"stub" /* STUB: force target non-Wall creature to attack or destroy at EOC */}},
{id:"sorceress_queen",  name:"Sorceress Queen",  type:"Creature",subtype:"Human Wizard",    color:"B",cmc:4,cost:"2BB", power:1,toughness:1,keywords:[],rarity:"R",text:"T: Target creature other than Sorceress Queen has base power and toughness 0/2 until end of turn.",activated:{cost:"T",effect:"stub" /* STUB: set target creature base P/T to 0/2 until EOT */}},
{id:"stromgald_cabal",  name:"Stromgald Cabal",  type:"Creature",subtype:"Human Knight",    color:"B",cmc:4,cost:"2BB", power:3,toughness:3,keywords:[],rarity:"R",text:"BB: Counter target white spell.",activated:{cost:"BB",effect:"stub" /* STUB: counter target white spell */}},
...
{id:"karma",                 name:"Karma",                 type:"Enchantment",color:"W",cmc:4,cost:"2WW", text:"At each player's upkeep, Karma deals damage to that player equal to their Swamp count.",upkeep:"stub" /* STUB: deal damage equal to controller's swamp count at each upkeep */,rarity:"U"},
...
{id:"hurkyls_recall",    name:"Hurkyl's Recall",   type:"Instant", color:"U",cmc:2,cost:"1U",  text:"Return all artifacts target player owns to their hand.",effect:"stub" /* STUB: return all artifacts a player owns to their hand */,rarity:"R"},
...
{id:"deathgrip",       name:"Deathgrip",       type:"Enchantment",color:"B",cmc:2,cost:"BB",  text:"BB: Counter target green spell.",activated:{cost:"BB",effect:"stub" /* STUB: counter target green spell */},rarity:"U"},
{id:"fear",            name:"Fear",            type:"Enchantment",subtype:"Aura",color:"B",cmc:2,cost:"1B",  text:"Enchanted creature has fear (can't be blocked except by artifact or black creatures).",effect:"stub" /* STUB: grant fear keyword to enchanted creature */,rarity:"C"},
...
{id:"howl_from_beyond",name:"Howl from Beyond",type:"Instant", color:"B",cmc:1,cost:"XB",  text:"Target creature gets +X/+0 until end of turn.",effect:"stub" /* STUB: target creature gets +X/+0 until end of turn */,rarity:"C"},
...
{id:"manabarbs",       name:"Manabarbs",       type:"Enchantment",color:"R",cmc:4,cost:"3R",  text:"Whenever a player taps a land for mana, Manabarbs deals 1 damage to that player.",effect:"stub" /* STUB: deal 1 damage to each player who taps a land for mana */,rarity:"R"},
{id:"mana_flare",      name:"Mana Flare",      type:"Enchantment",color:"R",cmc:3,cost:"2R",  text:"Whenever a player taps a land for mana, that player adds one mana of any type that land produced.",effect:"stub" /* STUB: all players get double mana from lands */,rarity:"R"},
...
{id:"smoke",           name:"Smoke",           type:"Enchantment",color:"R",cmc:2,cost:"1R",  text:"Players can't untap more than one creature during their untap steps.",effect:"stub" /* STUB: limit creature untap to one per player per untap step */,rarity:"R"},
...
{id:"lifeforce",       name:"Lifeforce",       type:"Enchantment",color:"G",cmc:2,cost:"GG",  text:"GG: Counter target black spell.",activated:{cost:"GG",effect:"stub" /* STUB: counter target black spell */},rarity:"U"},
...
{id:"meekstone",          name:"Meekstone",           type:"Artifact",color:"",cmc:1,cost:"1",text:"Creatures with power 3 or greater don't untap during their controllers' untap steps.",effect:"stub" /* STUB: prevent untap for all creatures with power 3 or greater */,rarity:"R"},
...
{id:"sunglasses_of_urza", name:"Sunglasses of Urza",  type:"Artifact",color:"",cmc:3,cost:"3",text:"Plains you control can tap to produce R in addition to W.",effect:"stub" /* STUB: Plains you control also produce R mana */,rarity:"U"},
...
{id:"winter_orb",         name:"Winter Orb",          type:"Artifact",color:"",cmc:2,cost:"2",text:"As long as Winter Orb is untapped, players can't untap more than one land during their untap steps.",effect:"stub" /* STUB: limit each player to untapping one land while this is untapped */,rarity:"R"},
