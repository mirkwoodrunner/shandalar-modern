          ...
          {COLORS.map(c => {
            ...
            return (
              <div key={c} onClick={() => setCol(c)} style={{
                ...
                <div style={{ fontSize:26, marginBottom:6 }}>{MANA_SYM[c]}</div>
